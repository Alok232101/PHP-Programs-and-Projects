    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><b>Quiz Mania</b></a>
            </div>
    ...
    <div class="container">
        ...
        <tr style="color:red"><td><center><b>Rank</b></center></td><td><center><b>Name</b></center></td><td><center><b>Email</b></center></td><td><center><b>Score</b></center></td></tr>';
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        $name = isset($row['name']) ? htmlspecialchars($row['name']) : 'Name Not Available';

                        $email = htmlspecialchars($row['email']);
                        $score = intval($row['score']);

                        echo "<tr><td><center>$rank</center></td><td><center>$name</center></td><td><center>$email</center></td><td><center>$score</center></td></tr>";
                        $rank++;
                        echo '<tr><td style="color:black"><center><b>' . $rank . '</b></center></td><td><center>' . $name . '</center></td><td><center>' . $email . '</center></td><td><center>' . $score . '</center></td></tr>';
                    }
                    echo '</table></div></div>';
                }
                ?>
